  ...
  <?php $title="Architects in Dwarka , Architects in Delhi , Architects in Gurgaon | Perfect Interior";
$Desc="Top Architects in Dwarka , Architects in Gurgaon - Delhi NCR, Dwarka Expressway. Architects Design Studio is one of the Top architecture firms & interior design firms in Dwarka for home, office, hotels, hospital architecture and interior design.  ";
$keywords="Architects near me , Architects in Dwarka, Architects in Delhi, Architects in Gurgaon, Architects in Delhi NCR, Architects in Dwarka Expressway "
...
<section id="about" class="about-area pt-80 pb-130">
   ...
   <div class="floating_from" style="z-index: 33; left:10%">

                <h3>Looking for architects?</h3>
...
Architects in Dwarka , Architects in Gurgaon - Delhi NCR, Dwarka Expressway</h1>
                    <p class="mt-25">Architects Design for interior designers. Challenge your inner creativity in the ideal workspace.
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="about-content mt-10 sub_services ">
                    <h2 class="about-welcome"> Specific Design Service</h2>
                            <p>
            ...
            <div class="col-md-6">
                <div class="about-content mt-10 sub_services">
                    <h2 class="about-welcome">Professional Design Service</h2>
                    <p>
