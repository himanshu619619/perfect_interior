<?php include 'header.php' ?>
        ...
        <div class="header-banner d-flex align-items-center">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-9 col-sm-10 hide_text">
                        <div class="banner-content">
                            <h4 class="sub-title wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">Your trusted</h4>
                            <h1 class="banner-title mt-10 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="2s"><span>Best Interior</span> Designers for Home or Office</h1>
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-45">
                        ...
                        <p class="mt-25">Perfect Interior company is one of the Best Interior Designers in Dwarka and Gurgaon. If want to hire the best interior designers in Delhi NCR then the first thing that you should contact us. Since many people today are searching for this kind of services, then we would help them to find the right one that would suit their needs. 
                           ...
                           <br> <a class="main-btn" href="tel:919654188876"><i class="lni-phone"></i> +91 96541 88876</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="contact-form">
                        <form id="contact-form" action="send_form_email.php" method="post" data-toggle="validator">
                            <div class="row">
                                <div class="col-md-6">
    ...
    <section id="map" class="map-area">
        <div class="mapouter">
            <div class="gmap_canvas">
                <iframe id="gmap_canvas" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d3503.621373492814!2d77.04395771549451!3d28.581130243155435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1580284215017!5m2!1sen!2sin" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
            </div>
        </div>
