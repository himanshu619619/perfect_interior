<?php $title="Interior decorator in Gurgaon, Delhi, Dwarka | Perfect Interior";
$Desc="Hire Best Interior Designers in Gurgaon & Delhi NCR for Your Home. Get Luxury Interior Service Tailored to Your Lifestyle. High-End Turnkey Solutions.";?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                ...
                <h3>Looking for Interior decorator?</h3>
            ...
            <div class="col-lg-6">
                <div class="about-content mt-40">
                    <h1 class="about-welcome ">Interior decorator</h1>
